...
export function SettingsProvider({ children }: SettingsProviderProps) {
  const [settings, setSettings] = useState<AppSettings>({
    ...
    address: "R. Felipe Camarão, 113 - Lorenzetti, Marília - SP, 17506-320",
    openingHoursWeekdays: "Seg - Sex: 09h às 18h",
    openingHoursWeekend: "Sáb: 09h às 13h",
    socialInstagram: "https://www.instagram.com/mlmotoscarmarilia",
    socialFacebook: "https://www.facebook.com/mlmotoscarmarilia",
    googleMapsUrl: "",
    defaultTheme: "dark",
  });
