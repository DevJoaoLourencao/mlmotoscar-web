  ...
  return (
    <div className="container mx-auto px-4 py-24 animate-fade-in-up">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        <Card className="bg-card border-border hover:border-primary/50 transition-all hover:-translate-y-1">
          <CardContent className="p-6 flex flex-col items-center text-center h-full justify-center">
            ...
            <h3 className="font-bold mb-3 text-foreground">Telefones</h3>
        ...
        <Card className="bg-card border-border hover:border-primary/50 transition-all hover:-translate-y-1">
          <CardContent className="p-6 flex flex-col items-center text-center h-full justify-center">
            ...
            <h3 className="font-bold mb-3 text-foreground">WhatsApp</h3>
            <div className="space-y-2">
              <a
                href={`https://wa.me/55${settings.phonePrimary.replace(/\D/g, '')}`}
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm text-muted-foreground hover:text-green-500 transition-colors block"
              >
                <div className="font-semibold text-foreground text-xs mb-0.5">
                  {settings.phonePrimaryName}
                </div>
        ...
        <Card className="bg-card border-border hover:border-primary/50 transition-all hover:-translate-y-1">
          <CardContent className="p-6 flex flex-col items-center text-center h-full justify-center">
            ...
            <h3 className="font-bold mb-2 text-foreground">Horários</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Left: Map */}
        <Card className="bg-card border-border overflow-hidden h-full min-h-[400px]">
          <div className="w-full h-full relative">
            ...
            <div className="absolute bottom-4 right-4 z-10">
              ...
              >
                <Button
                  variant="outline"
                  className="gap-2 border-primary/20 hover:border-primary text-foreground hover:bg-primary/5 bg-background/90 backdrop-blur-sm"
                >
          ...
          <CardContent className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  name="message"
                  className="flex min-h-[120px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus:border-primary transition-colors disabled:cursor-not-allowed disabled:opacity-50"
